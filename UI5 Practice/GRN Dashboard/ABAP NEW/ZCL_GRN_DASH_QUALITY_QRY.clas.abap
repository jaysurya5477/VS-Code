*"* Query provider for custom entity ZMM_GRN_DASH_QUALITY.
...
CLASS zcl_grn_dash_quality_qry DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_grn_dash_quality_qry IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA lt_out TYPE STANDARD TABLE OF zmm_grn_dash_quality.
    lt_out = VALUE #( FOR ls IN ls_dash-quality (
                        bucket   = ls-bucket
                        qty      = ls-qty
