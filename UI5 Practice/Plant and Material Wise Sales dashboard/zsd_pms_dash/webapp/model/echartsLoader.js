sap.ui.define([], function () {
	 ...
	 * resolves with the global `echarts` namespace. Ported from the GRN Dashboard's
	 * echartsLoader.js (../../GRN Dashboard/zmm_grn_dash), re-pathed to this app's namespace.
	 *
	 * Deliberately a plain <script> tag rather than sap.ui.require with an AMD shim:
	 * ECharts' UMD wrapper only assigns window.echarts when define.amd is falsy, which is
	 * precisely the case under the UI5 loader. A script tag therefore needs no shim
	...
	return {
		...
		load: function () {
			...
			oLoad = new Promise(function (resolve, reject) {
				...
				var sUrl = sap.ui.require.toUrl("com/sap/zsdpmsdash/libs/echarts.min.js");
				var oScript = document.createElement("script");
				oScript.id = "pmsDashECharts";
				oScript.src = sUrl;
				oScript.async = true;
