*"* Query provider for custom entity ZSD_PMS_SCHEME.
...
*"* blocks). Maps ls_dash-scheme (1 row per category/scheme).
CLASS zcl_pms_scheme_qry DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_pms_scheme_qry IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA lt_out TYPE STANDARD TABLE OF zsd_pms_scheme.
    lt_out = VALUE #( FOR ls IN ls_dash-scheme (
